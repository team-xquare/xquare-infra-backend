...
import xquare.app.xquareinfra.application.container.port.`in`.GetContainerHttpRequestPerMinuteUseCase
...
) : xquare.app.xquareinfra.application.container.port.`in`.GetContainerHttpRequestPerMinuteUseCase {
